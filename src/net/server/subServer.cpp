...
subServer::subServer(QObject *parent, string port, int breite, int hoehe, int anzSpieler) : QThread(parent){
        ...
        if(this->sock2.recv(s)){
            ...
            if(s.length() > 0){
                ...
                while(abschnitt < max){
                    ...
                    case 222:
                        cout << "Server hat empfangen CODE 222\nSpielername und Client ID erwartet. Bekommen:\n\n" << endl;
